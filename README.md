...
## [Settings](https://github.com/Animehub4u/Notpixel-bot/blob/main/.env-example)
...
## Installation
You can download the [**repository**](https://github.com/Animehub4u/Notpixel-bot) by cloning it to your system and installing the necessary dependencies:
```shell
git clone https://github.com/Animehub4u/Notpixel-bot.git
cd Notpixel-bot
```
